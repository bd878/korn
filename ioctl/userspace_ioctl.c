...
/*
 * device specifics, such as ioctl numbers
 * and the major device file
 */
#include "chardev.h"
...
int ioctl_get_msg(int file_desc)
{
  ...
  /* this operation is dangerous because we don't tell
   * the kernel how far it's allowed to write, it might
   * overflow the buffer. In a real production program,
   * we would have used two ioctls - one to tell the kernel
