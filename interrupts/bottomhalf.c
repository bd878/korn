 ...
 *
 * Based upon the RPi example by Stefan Wendler:
 * github.com/wendlers/rpi-kmod-samples
 *
 * Press one button to rurn on an LED and another to turn it off
 */
 ...
 * Must change the numbers for the GPIO on board
 */
...
static irqreturn_t button_isr(int irq, void *data)
{
  ...
  /* do the reset at leisure via the scheduler */
...
static int __init bottomhalf_init(void)
{
  ...
  ret = request_irq(button_irqs[0], button_isr,
                    IRQS_TRIGGER_RISING | IRQS_TRIGGER_FALLING,
